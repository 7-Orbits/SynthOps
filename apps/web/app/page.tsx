    ...
    <div className={styles.page}>
      <main className={styles.hero}>
        ...
        <div className={styles.ctaGroup}>
          ...
          <a href="https://github.com/7-Orbits/SynthOps" target="_blank" rel="noopener noreferrer" className={styles.secondaryCta}>
            <svg
              width="20"
              height="20"
              viewBox="0 0 24 24"
      ...
      <footer className={styles.footer}>SynthOps | A product by 7.Orbits</footer>
    </div>
  );
}
